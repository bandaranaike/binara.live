                        ...
                        <div className="relative z-10 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
                            <div className="max-w-3xl">
                                ...
                                <h1 className="mt-3 section-title">
                                    Trusted medical, dental, and specialist care in Kundasale.
                                </h1>
                                <p className="mt-3 max-w-2xl section-copy">
                                    Book appointments, check doctor availability, and get patient-first care from a team serving Kandy with OPD, specialist, and dental services.
                                </p>
                            </div>
                            <div className="content-panel p-5">
                                <div className="text-sm font-semibold uppercase tracking-[0.2em] text-purple-600">Quick access</div>
                                <div className="mt-2 text-2xl font-black text-slate-900">Plan your visit</div>
                                <p className="mt-2 text-sm text-slate-600">Check today&apos;s availability or explore the full calendar before you book.</p>
                                <Link
                        ...
                        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                            {services.map((service, index) => (
                                <div className="overflow-hidden rounded-xl border border-purple-100 bg-white/90 text-center" key={index}>
                                    ...
                                    <h3 className="px-4 pt-10 text-2xl font-semibold">{service.title}</h3>
